...
static const AVOption options[] = {
    ...
    {"hls_playlist_filename_prefix",  "string to append to each playlist entry",   OFFSET(playlist_filename_prefix), AV_OPT_TYPE_STRING, {.str = NULL},  0, 0,       E},
    {"hls_playlist_filename_suffix",  "string to append to each playlist entry",   OFFSET(playlist_filename_suffix), AV_OPT_TYPE_STRING, {.str = NULL},  0, 0,       E},   
